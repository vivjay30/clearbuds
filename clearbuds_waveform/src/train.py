...
def main(args):
    ...
    data_train = SpatialAudioDatasetWaveform(args.train_dir, n_mics=args.n_mics,
                                             sr=args.sample_rate,
                                             target_fg_std=None, target_bg_std=None,
                                             perturb_prob=0.0,
                                             n_speakers=2, chunk_size=args.chunk_size)
    data_test = SpatialAudioDatasetWaveform(args.valid_dir, n_mics=args.n_mics,
                                            sr=args.sample_rate,
                                            target_fg_std=None, target_bg_std=None,
                                            perturb_prob=0.0,
                                            n_speakers=2, chunk_size=args.chunk_size)
    ...
    model = ConvTasNet.load_model("checkpoints/clearvoice_iphone_causal_mixed_l1spec_loss_large/final.pth.tar",
