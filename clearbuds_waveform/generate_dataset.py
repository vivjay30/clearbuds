...
def generate_sample(args: argparse.Namespace, bg: np.ndarray, idx: int) -> int:
    ...
    mic_radius = np.random.uniform(low=0.05, high=0.125)
    ...
    for voice_idx in range(args.n_voices):
        ...
        mic_array = generate_mic_array(room, mic_radius, args.n_mics)
    ...
    metadata['mic_radius'] = mic_radius
